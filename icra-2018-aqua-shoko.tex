...
\title{\LARGE \bf
Underwater Legged Robot for Low-Signature, Underwater Exploration% for the MDS Robot
}


\author{Alberto Perez Nunez$^{1}$ and Daniel M. Lofaro$^{2}$% <-this % stops a space
...
\bibliography{aquashoko.bib,lofaro.bib}
